...
//		           			.rolls(ConstantLootTableRange.create(CONFIG.rolls.carrot_rolls))
//		           			.with(ItemEntry.builder(Items.CARROT))
//		           			.rolls(ConstantLootTableRange.create(CONFIG.rolls.melon_seeds_rolls))
//		           			.with(ItemEntry.builder(Items.MELON_SEEDS))
//		           			.rolls(ConstantLootTableRange.create(CONFIG.rolls.pumpkin_seeds_rolls))
//		           			.with(ItemEntry.builder(Items.PUMPKIN_SEEDS))
//		           			.rolls(ConstantLootTableRange.create(CONFIG.rolls.beetroot_seeds_rolls))
//		           			.with(ItemEntry.builder(Items.BEETROOT_SEEDS))
//		           			.rolls(ConstantLootTableRange.create(CONFIG.rolls.wheat_seeds_booster_rolls))
//		           			.with(ItemEntry.builder(Items.WHEAT_SEEDS))
//		           			.rolls(ConstantLootTableRange.(CONFIG.rolls.potato_rolls))
